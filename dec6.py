def find_length_of_infinite_loop(initial_allocation_str):
...
print find_length_of_infinite_loop("0 2 7 0")
print find_length_of_infinite_loop("14 0 15 12 11 11 3 5 1 6 8 4 9 1 8 4")
